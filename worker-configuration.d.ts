/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c9b7f9d97e79aa961a1df32c71f34cb5)
// Runtime types generated with workerd@1.20260811.1 2026-07-15 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	SIGNALING_ROOM: DurableObjectNamespace<import("./src/worker").SignalingRoom>;
	STATUS_STORE: DurableObjectNamespace<import("./src/worker").StatusStore>;
	BEER_MAP: Fetcher /* manbesi-beer-map */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "SignalingRoom" | "StatusStore";
	}
